...
- **P0（当前）**：bmob、bmob-mcp、database × 6 端（JS / Android / iOS legacy / **Swift** / **Flutter** / REST）、error-codes；[`shared/faq.md`](shared/faq.md)、[`anti-patterns`](shared/anti-patterns.md)、[`recipes/`](shared/recipes/)
