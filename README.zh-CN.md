...
- **P0（当前）**：bmob、bmob-mcp、database × 5 端（JS / Android / iOS / **Flutter** / REST）、error-codes；[`shared/faq.md`](shared/faq.md)、[`anti-patterns`](shared/anti-patterns.md)、[`recipes/`](shared/recipes/)
